...
class _InscriptionClientState extends ConsumerState<InscriptionClient> {
  ...
  void _afficherConditions(BuildContext context) {
    ...
    const texteParDefaut = "Bienvenue sur la plateforme CamTrans.\n\n"
                    ...
                    child: Column(
                      children: [
                          ...
                          children: [
                            Expanded(
                              child: ChampTexte(
                                ...
                                validateur: (valeur) => Validateurs.obligatoire(
                                    valeur,
                                    nomChamp: "La ville"),
                              ),
                            ),
                        ...
                        ChampTexte(
                          ...
                          estMotDePasse: true,
                          validateur: (valeur) =>
                              Validateurs.confirmerMotDePasse(
                                  valeur, _motDePasse.text),
                        ),
                      ],
                    ),
                  ),
