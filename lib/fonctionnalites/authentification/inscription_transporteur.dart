...
class InscriptionTransporteur extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<InscriptionTransporteur> createState() =>
      _InscriptionTransporteurState();
}

class _InscriptionTransporteurState
    extends ConsumerState<InscriptionTransporteur> {
  ...
  Future<void> _inscription() async {
    ...
    if (_gammeChoisie == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content:
                Text("Veuillez choisir la gamme souhaitée (Éco ou Confort).")),
      );
      return;
    }
    ...
    if (_photoPermis == null ||
        ...
        _photoVehiculeAvant == null ||
        _photoVehiculeArriere == null ||
        _photoVehiculeProfil == null ||
        _photoVehiculeInterieur == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text(
                "Veuillez fournir tous les documents requis (incluant les 4 photos du véhicule).")),
      );
      return;
    }
    ...
    try {
      ...
      if (userCred.user != null) {
        ...
        String urlPermis = await serviceStockage.uploaderFichier(
                fichier: _photoPermis!,
                dossier: "transporteurs/$uid",
                nomFichier: "permis") ??
            "";
        String urlCarteGrise = await serviceStockage.uploaderFichier(
                fichier: _photoCarteGrise!,
                dossier: "transporteurs/$uid",
                nomFichier: "carte_grise") ??
            "";
        String urlAssurance = await serviceStockage.uploaderFichier(
                fichier: _photoAssurance!,
                dossier: "transporteurs/$uid",
                nomFichier: "assurance") ??
            "";

        String urlAvant = await serviceStockage.uploaderFichier(
                fichier: _photoVehiculeAvant!,
                dossier: "transporteurs/$uid",
                nomFichier: "vehicule_avant") ??
            "";
        String urlArriere = await serviceStockage.uploaderFichier(
                fichier: _photoVehiculeArriere!,
                dossier: "transporteurs/$uid",
                nomFichier: "vehicule_arriere") ??
            "";
        String urlProfil = await serviceStockage.uploaderFichier(
                fichier: _photoVehiculeProfil!,
                dossier: "transporteurs/$uid",
                nomFichier: "vehicule_profil") ??
            "";
        String urlInterieur = await serviceStockage.uploaderFichier(
                fichier: _photoVehiculeInterieur!,
                dossier: "transporteurs/$uid",
                nomFichier: "vehicule_interieur") ??
            "";

        List<String> urlsVehicule = [
          urlAvant,
          urlArriere,
          urlProfil,
          urlInterieur
        ...
        final prenom = nomComplet.length > 1
            ? nomComplet.sublist(0, nomComplet.length - 1).join(' ')
            : "";
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
              "Inscription réussie. Veuillez vous connecter pour accéder à votre tableau de bord."),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
              "Erreur lors de l'inscription : ${e.toString().replaceAll('Exception:', '')}"),
  ...
  void _afficherConditions() {
    ...
    final texteConditions = textesAsync.whenOrNull(
          data: (textes) =>
              textes.get('conditions_transporteur', texteParDefaut),
        ) ??
        texteParDefaut;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Inscription Transporteur",
                    ...
                    child: Column(
                      children: [
                        ...
                        ChampTexte(
                          ...
                          validateur: (v) =>
                              Validateurs.obligatoire(v, nomChamp: "Ville"),
                        ),
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        const Align(
                          alignment: Alignment.centerLeft,
                          child: Text("Informations Professionnelles",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 16,
                                  color: CouleursApp.primaire)),
                            ...
                            decoration: InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                ...
                                borderSide: const BorderSide(
                                    color: CouleursApp.primaire, width: 2),
                              ),
                              filled: true,
                              fillColor: Colors.grey.shade50,
                            ),
                        ...
                        Theme(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: ["Éco", "Confort"]
                                ...
                                .toList(),
                            validator: (v) =>
                                v == null ? "Veuillez choisir une gamme" : null,
                            onChanged: (v) {
                              setState(() {
                                _gammeChoisie = v;
                              });
                        ...
                        ChampTexte(
                          ...
                          validateur: (v) => Validateurs.obligatoire(v,
                              nomChamp: "Immatriculation"),
                        ),
                        const SizedBox(height: 15),
                        ChampTexte(
                          ...
                          validateur: (v) =>
                              Validateurs.obligatoire(v, nomChamp: "Permis"),
                        ),
                        const SizedBox(height: 15),
                        ChampTexte(
                          ...
                          typeClavier: const TextInputType.numberWithOptions(
                              decimal: true),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Text("Photos de vérification du véhicule :",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 13,
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              _buildDocItem(
                                  "Face Avant (Plaque visible)",
                                  Icons.front_hand,
                                  _photoVehiculeAvant != null,
                                  () => _pickImage('vehicule_avant')),
                              _buildDocItem(
                                  "Face Arrière (Plaque visible)",
                                  Icons.directions_car,
                                  _photoVehiculeArriere != null,
                                  () => _pickImage('vehicule_arriere')),
                              _buildDocItem(
                                  "Profil (Carrosserie)",
                                  Icons.photo_size_select_actual,
                                  _photoVehiculeProfil != null,
                                  () => _pickImage('vehicule_profil')),
                              _buildDocItem(
                                  "Intérieur (Cabine / Chargement)",
                                  Icons.event_seat,
                                  _photoVehiculeInterieur != null,
                                  () => _pickImage('vehicule_interieur')),
                            ],
                          ),
                        ),
                      ],
                    ...
                    child: Column(
                      children: [
                        ...
                        ChampTexte(
                          ...
                          icone: Icons.lock_outline,
                          estMotDePasse: true,
                          validateur: (v) => Validateurs.confirmerMotDePasse(
                              v, _motDePasse.text),
                        ),
                      ],
                    ),
  ...
  Widget _buildDocItem(
      String titre, IconData icone, bool isUploaded, VoidCallback onTap,
      {int? count}) {
    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(10),
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icone,
                color: isUploaded ? CouleursApp.succes : Colors.grey, size: 24),
              ...
              Padding(
                ...
                child: Text("($count/4)",
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color:
                            count >= 4 ? CouleursApp.succes : Colors.orange)),
              ),
            Icon(
