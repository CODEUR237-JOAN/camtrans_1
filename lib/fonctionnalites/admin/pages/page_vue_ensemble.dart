...
class PageVueEnsemble extends ConsumerWidget {
                          ...
                          return GridView.count(
                            ...
                            children: [
                              _KpiCard(
                                  titre: "Revenus",
                                  valeur:
                                      "${NumberFormat.compact().format(stats.revenusTotaux)} F",
                                  icone: Iconsax.wallet_3_copy,
                                  couleur: CouleursApp.succes,
                                  sparklineData: stats.revenusHistory,
                                  trend: stats.trendRevenus),
                              _KpiCard(
                                  titre: "Clients Actifs",
                                  valeur: stats.totalClients.toString(),
                                  icone: Iconsax.user_copy,
                                  couleur: CouleursApp.secondaire,
                                  sparklineData: stats.clientsHistory,
                                  trend: stats.trendClients),
                              _KpiCard(
                                  titre: "Transporteurs",
                                  valeur: stats.totalTransporteurs.toString(),
                                  icone: Iconsax.truck_fast_copy,
                                  couleur: CouleursApp.avertissement,
                                  sparklineData: stats.transporteursHistory,
                                  trend: stats.trendTransporteurs),
                              _KpiCard(
                                  titre: "Courses Totales",
                                  valeur: stats.totalCourses.toString(),
                                  icone: Iconsax.route_square_copy,
                                  couleur: CouleursApp.primaire,
                                  sparklineData: stats.coursesHistory,
                                  trend: stats.trendCourses),
                            ],
                          );
                        },
                      ),
                        ...
                        if (constraints.maxWidth > 1100) {
                          return Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                  flex: 2,
                                  child: _buildCarteTransporteurs(
                                      transporteursAsync, ref, isSatellite)),
                            ],
                          );
                        } else {
                          return Column(
  ...
  void _telechargerRapport(WidgetRef ref) async {
              ...
              data: courses
                  .map((c) => <String>[
                        ...
                        c.clientId.length > 8
                            ...
                            : c.clientId,
                        c.transporteurId.isEmpty
                            ? 'Aucun'
                            : (c.transporteurId.length > 8
                                ? c.transporteurId.substring(0, 8)
                                : c.transporteurId),
                        c.statut,
    ...
    telechargerFichier(
        bytes, "rapport_camtrans_${DateTime.now().millisecondsSinceEpoch}.pdf");
  }
            ...
            content: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  const SizedBox(width: 8),
                  Expanded(
                      child: Text("Départ: ${course.adresseDepart}",
                ...
                Row(children: [
                  ...
                  const SizedBox(width: 8),
                  Expanded(
                      child: Text("Arrivée: ${course.adresseArrivee}",
                          style: GoogleFonts.inter(color: Colors.white70))),
                ]),
                const SizedBox(height: 16),
                Text(
                    "Prix: ${course.prixFinal > 0 ? course.prixFinal : course.prixEstime} F",
                    style: GoogleFonts.inter(
          ...
          normalizedData.forEach((key, value) {
            sections.add(PieChartSectionData(
              ...
              titleStyle: GoogleFonts.inter(
                  fontWeight: FontWeight.bold,
                  color: Colors.white,
                  fontSize: 14), // Show internal value
            ));
          });
          ...
          return Column(
            ...
            children: [
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                            "${normalizedData.values.fold(0, (a, b) => a + b)}",
                            style: GoogleFonts.inter(
                                color: Colors.white,
                                fontSize: 32,
                                fontWeight: FontWeight.bold)),
              ...
              Wrap(
                ...
                spacing: 16,
                runSpacing: 12,
                children: normalizedData.entries
                    .toList()
                    .asMap()
                    .entries
                    .map((entry) {
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              "${DateFormat('dd MMM').format(c.dateCreation)} • ${c.prixFinal > 0 ? c.prixFinal : c.prixEstime} F",
                              style: GoogleFonts.inter(
  ...
  Widget _buildGraphiqueRevenus(AsyncValue<List<double>> weeklyRevenuesAsync) {
    return _CarteGlass(
      ...
      enfant: weeklyRevenuesAsync.when(
        loading: () => Container(color: Colors.white.withValues(alpha: 0.05))
              ...
              titlesData: FlTitlesData(
                ...
                bottomTitles: AxisTitles(
                  sideTitles: SideTitles(
                    ...
                    reservedSize: 30,
                    interval:
                        1, // Fix fractional values creating duplicate labels
  ...
  Widget _buildCarteTransporteurs(
      AsyncValue<List<Transporteur>> transporteursAsync,
      WidgetRef ref,
      bool isSatellite) {
    return Container(
      decoration: BoxDecoration(
                ...
                return Marker(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(
                            color: t.disponible ? Colors.blue : Colors.grey,
                            width: 2),
                        boxShadow: [
                          BoxShadow(
                              color: (t.disponible ? Colors.blue : Colors.grey)
                    ...
                    child: Icon(iconData,
                        color: t.disponible ? Colors.white : Colors.white70,
                        size: 22),
                  ),
                );
              }).toList();
...
class _KpiCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: const Color(
              0xFF10192A), // Darker blue/grey background matching reference
          borderRadius:
              BorderRadius.circular(12), // Less rounded, more professional
          border:
          ...
          Row(
            children: [
              ...
              Text("${trend >= 0 ? '+' : ''}${trend.toStringAsFixed(1)}%",
                  style: GoogleFonts.inter(
                      color:
                          trend >= 0 ? CouleursApp.succes : CouleursApp.erreur,
                      fontSize: 11,
                      fontWeight: FontWeight.bold)),
              const SizedBox(width: 4),
...
class _CarteGlass extends StatelessWidget {
  ...
  const _CarteGlass(
      {required this.titre, required this.enfant, required this.hauteur});
      ...
      children: [
        FlutterMap(
          ...
          children: [
            TileLayer(
              urlTemplate:
                  widget.isSatellite ? urlCarteSatellite : urlCarteStandard,
