...
class _DocumentsState extends ConsumerState<Documents> {
  ...
  Future<void> _uploaderDocument(String documentId, String label,
      String fieldName, String transporteurId) async {
        ...
        if (url != null) {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                  content: Text("$label importé avec succès !"),
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          ...
          builder: (context, snapshot) {
            ...
            final transporteur = Transporteur.fromMap(
            ...
            Widget buildLigneDocument({
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: _chargement
                      ? const SizedBox(
                          width: 20, height: 20, child: LoaderPremium())
                      : IconButton(
                          icon: Icon(estImporte ? Icons.edit : Icons.upload),
                          color: CouleursApp.primaire,
                          onPressed: () => _uploaderDocument(
                              label, label, fieldName, transporteurId),
                        ),
                ),
              );
            }
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("Liste des documents",
                      style:
                  ...
                  Card(
                    ...
                    child: const ListTile(
                      ...
                      title: Text("Conseil"),
                      subtitle: Text(
                          "Une fois tous les documents importés, l'équipe d'administration validera votre dossier."),
                    ),
                  ),
