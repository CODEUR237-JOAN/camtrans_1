...
class ServicePaiement {
  ...
  Future<Paiement> _initierCollecteMobileMoney({
    ...
    // Pour la soutenance, on envoie 10 FCFA à Campay, mais on enregistre le vrai prix dans Firebase.
  ...
  Future<Paiement> _creerPaiementReussi({
    ...
    final paiement = Paiement(
      ...
      fraisTransaction: methode == "Espèces" ? 0.0 : montant * 0.02,
      montantNet: methode == "Espèces" ? 0.0 : montant * 0.98,
